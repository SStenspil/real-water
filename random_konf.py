...
#constraints.AddDistanceConstraint(1, 10, 1.0)       # Angstrom
...
for j in range(1000):
    ...
    for n in range(len(theta)):
        for i in range(0,18,3): # 18 = number of atoms
            ...
            new_point_x,new_point_y,new_point_z = m.Rot(point,p1,p2,theta[n])
            #print new_point_x
            x[1+i]=new_point_x
            y[1+i]=new_point_y
            z[1+i]=new_point_z
            ...
            new_point_x,new_point_y,new_point_z = m.Rot(point,p1,p2,theta2[n])
            x[2+i]=new_point_x
            y[2+i]=new_point_y
            z[2+i]=new_point_z
    ...
    if energy_new < energy_old:
        os.system("mv water_HE.xyz w6_copy.xyz")
